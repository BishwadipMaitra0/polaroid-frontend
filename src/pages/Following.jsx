                        ...
                        <div class="network-main">
                            <div class="network-content">
                                <div class="network-select-section">
                                    <div class="nav-link">
                                        <a href={"/followers/" + user.split(" ").join("%20")} class="section-name">followers</a>
                                    </div>
                                    <div class="nav-link">
                                        <a href={"/following/" + user.split(" ").join("%20")} class="section-name active">following</a>
                                    </div>
                                </div >
                                        ...
                                        <div class="follower-slice">
                                            ...
                                            <div class="follower-social-info">
                                                ...
                                                <div class="follower-list" title="Lists">
                                                    ...
                                                    <a href={"/lists/" + item.username} class="follower-list-count"> {item.lists || "0"} </a>
                                                </div>
