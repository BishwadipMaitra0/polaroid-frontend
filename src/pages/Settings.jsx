            ...
            <div class="settings-main">
                ...
                <form class="main-container" onSubmit={submitHandler}>
                    <div class="info-container">
                        ...
                        <input class="password-box" name="originalPassword" type="password" value={originalPassword} onChange={(e) => setPassword(e.target.value)} id="origPs" autoComplete="off" />

                        <label class="label-input" for="password-input">New password</label>
                        <input class="password-box" name="newPassword" type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} id="password-input" autoComplete="off" />

                        <label class="label-input" for="repassword-input">Re-enter new password</label>
                        <input class="password-box" name="reenterNewPassword" onChange={(e) => setRepeatNewPassword(e.target.value)} type="password" id="repassword-input" autoComplete="off" />
